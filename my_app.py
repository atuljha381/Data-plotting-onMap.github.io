...
DATA_URL = (
    "D:\program files\data_science\Motor_Vehicle_Collisions_-_Crashes.csv"
)

st.title("Motor vehicle collisions in new york city")
st.markdown("Here it shows the collision data of moto vehicles in new york city 🚗 ")
...
#hour_choose = st.selectbox("Hour to look at",range(0,24),1) data = data[data['date/time'].dt.hour == hour_choose]
